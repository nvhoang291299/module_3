...
<body>
    <div class="container">
        ...
        <div class="mb-5">
            ...
            <button type="submit" class="btn btn-primary"><a href="/list?actionUser=search"></a>Search</button>
        </div>
        <table class="table table-striped text-center border bound-1">
            ...
            <c:forEach var="product" items="${products}" varStatus="loop">
                <tr>
                    ...
                    <button type="submit" class="btn btn-danger"><a href="/list?actionUser=delete">Delete</a></button></td>
